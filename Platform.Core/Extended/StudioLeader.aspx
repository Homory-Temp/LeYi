<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudioLeader.aspx.cs" Inherits="Extended.ExtendedStudioLeader" %>
    ...
    <form id="formHome" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panelInner" runat="server">
            ...
            <telerik:RadListView ID="view" runat="server" OnNeedDataSource="view_NeedDataSource">
                <ItemTemplate>
                    <telerik:RadButton ID="btn" runat="server" Width="100" GroupName="LeaderGroup" AutoPostBack="true" Skin="Metro" ButtonType="ToggleButton" Checked='<%# Count((Guid)Eval("Id")) %>' ToggleType="Radio" Text='<%# Eval("RealName") %>' Value='<%# Eval("Id") %>' OnClick="btn_Click"></telerik:RadButton>&nbsp;&nbsp;
                </ItemTemplate>
            </telerik:RadListView>
            <br /><br />
