<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatalogUsers.aspx.cs" Inherits="Extended.ExtendedCatalogUsers" %>
    ...
    <form id="formHome" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panelInner" runat="server">
            ...
            <telerik:RadListView ID="view" runat="server" OnNeedDataSource="view_NeedDataSource">
                <ItemTemplate>
                    <telerik:RadButton ID="btn" Width="80" runat="server" GroupName="LeaderGroup" AutoPostBack="true" Skin="Metro" ToggleType="CheckBox" Checked='<%# Count((Guid)Eval("Id")) %>' Text='<%# Eval("RealName") %>' Value='<%# Eval("Id") %>' OnClick="btn_Click"></telerik:RadButton>&nbsp;&nbsp;
                </ItemTemplate>
            </telerik:RadListView>
            <br /><br />
