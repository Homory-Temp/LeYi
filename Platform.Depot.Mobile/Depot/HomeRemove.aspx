<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeRemove.aspx.cs" Inherits="Depot_HomeRemove" %>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <telerik:RadTextBox ID="name" runat="server" EmptyMessage="请在此处输入完整的仓库名称" Width="400" EnabledStyle-HorizontalAlign="Center"></telerik:RadTextBox>
                        </div>
                    </div>
                    <div class="row">&nbsp;</div>
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <input type="button" class="btn btn-tumblr" id="remove" runat="server" value="删除" onserverclick="remove_ServerClick" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
