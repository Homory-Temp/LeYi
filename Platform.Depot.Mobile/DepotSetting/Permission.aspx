<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Permission.aspx.cs" Inherits="DepotSetting_Permission" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <telerik:RadTreeView ID="tree" runat="server" OnNodeClick="tree_NodeClick" DataTextField="Name" DataValueField="Id">
                                <NodeTemplate>
                                    <%# Eval("Name") %><%# (Container.DataItem as Models.DepotRole).State == Models.State.内置 ? "（内置）" : "" %>
                                </NodeTemplate>
                            </telerik:RadTreeView>
                        </div>
                    </div>
                ...
                <div class="col-md-10" style="text-align: left;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            &nbsp;&nbsp;
                            <telerik:RadButton ID="r1" runat="server" Text="物资管理" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="CheckBox" Value="Action"></telerik:RadButton>
                            &nbsp;&nbsp;
                            <telerik:RadButton ID="r2" runat="server" Text="查询统计" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="CheckBox" Value="Query"></telerik:RadButton>
                            &nbsp;&nbsp;
                            <telerik:RadButton ID="r3" runat="server" Text="高级功能" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="CheckBox" Value="Root"></telerik:RadButton>
                            &nbsp;&nbsp;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <telerik:RadSearchBox ID="search" runat="server" EmptyMessage="用户姓名或拼音首字母" DataTextField="Name" DataValueField="Id" MaxResultCount="10" LocalizationPath="~/Language" ShowLoadingIcon="false" ShowSearchButton="false" OnDataSourceSelect="search_DataSourceSelect" OnSearch="search_Search"></telerik:RadSearchBox>
                        </div>
                    </div>
                    <div class="row">&nbsp;</div>
