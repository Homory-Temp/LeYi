                            ...
                            <div class="panel" style="background-color: transparent; box-shadow: none;">
                                <div class="panel-body" style="border: none; padding-top: 0; background-color: transparent; text-align: center;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <telerik:RadListView ID="list" runat="server" OnNeedDataSource="list_NeedDataSource" CssClass="container-fluid">
                                            <ItemTemplate>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <input type="button" class='<%# "btn btn-lg btn-{0} dictionary".Formatted(Eval("Id").ToString().ToLower() == ___id.Value.ToLower() ? "warning" : "info") %>' id="do_in" runat="server" uid='<%# Eval("Id") %>' value='<%# Eval("Name") %>' onserverclick="do_in_ServerClick" />
                                                    </div>
                                                </div>
                                            </ItemTemplate>
                                        </telerik:RadListView>
