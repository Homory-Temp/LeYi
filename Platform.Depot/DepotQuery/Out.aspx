...
<body>
    <form id="form" runat="server">
        ...
        <telerik:RadWindowManager runat="server" ID="Rwm" Skin="Metro">
            <Windows>
                <telerik:RadWindow ID="popup_win" runat="server" Title="报废流程" ReloadOnShow="True" Width="800" Height="450" VisibleStatusbar="false" Behaviors="Move,Close" Modal="True" CenterIfModal="True" Localization-Close="关闭">
                </telerik:RadWindow>
            </Windows>
                        ...
                        <telerik:RadListView ID="view" runat="server" OnNeedDataSource="view_NeedDataSource" ItemPlaceholderID="holder" AllowPaging="true">
                                ...
                                <div class="col-md-12">
                                    <table class="storeTable text-center">
                                        <tr>
                                            ...
                                            <th>审批状态</th>
                                            <th>审批流程</th>
                                            <th style='<%# (RightRoot ? "display: none;": "display: none;") %>'>操作</th>
                                        </tr>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style='<%# (RightRoot ? "display: none;": "display: none;") %>'>
                                    ...
                                    <td>
                                        <input type="button" class="btn btn-tumblr" value="流程" id="fs" match='<%# Eval("PreservedA") %>' runat="server" onserverclick="fs_ServerClick" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <EmptyDataTemplate>
