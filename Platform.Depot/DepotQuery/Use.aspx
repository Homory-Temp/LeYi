<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Use.aspx.cs" Inherits="DepotQuery_Use" %>
        ...
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="container-fluid" LoadingPanelID="loading">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <telerik:RadComboBox ID="peopleX" runat="server" MaxHeight="203" AutoPostBack="false" Width="120" DataTextField="Name" DataValueField="Id" AppendDataBoundItems="true" Filter="Contains" AllowCustomText="true">
                        <ItemTemplate>
                ...
                <telerik:RadListView ID="view" runat="server" OnNeedDataSource="view_NeedDataSource" ItemPlaceholderID="holder" AllowPaging="true">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# UserName((Guid)Eval("UserId")) %></td>
                            <td><%# Eval("Money").ToMoney() %></td>
                            <td><%# UserName((Guid)Eval("OperatorId")) %></td>
                            <td>
