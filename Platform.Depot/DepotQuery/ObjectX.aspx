<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObjectX.aspx.cs" Inherits="DepotQuery_Object" %>
...
<body>
    <form id="form" runat="server">
        ...
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="container" LoadingPanelID="loading">
            ...
            <div class="row">
                <telerik:RadGrid ID="grid" runat="server" CssClass="col-md-12 text-center" AutoGenerateColumns="false" LocalizationPath="../Language" AllowSorting="True" PageSize="20" GridLines="None" OnNeedDataSource="grid_NeedDataSource">
                    <MasterTableView DataKeyNames="Id,Fixed,Ordinal" HorizontalAlign="NotSet" ShowHeader="true" ShowHeadersWhenNoRecords="true" NoMasterRecordsText="">
