<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutX.aspx.cs" Inherits="DepotQuery_InPrint" %>
            ...
            <telerik:RadListView ID="viewx" runat="server" OnNeedDataSource="viewx_NeedDataSource" ItemPlaceholderID="holder" AllowPaging="false">
                <LayoutTemplate>
                    <table class="storeTablePrint text-center" style="margin: 0 auto; width: 90%;">
                        <tr>
                            <th colspan="12" style="font-size: 18px; font-weight: bold; padding: 10px; border: none;"><span>报废流程</span></th>
                        </tr>
                        <tr>
                            <th>办理步骤</th>
                            <th>办理人</th>
