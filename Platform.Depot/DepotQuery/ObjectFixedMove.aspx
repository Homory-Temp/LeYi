<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObjectFixedMove.aspx.cs" Inherits="DepotQuery_ObjectFixedMove" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="storeTable">
                        <tr>
                            <td style="width: 15%;">
                                <span class="btn btn-info dictionaryX">总库数量：</span>
                            </td>
                            <td style="width: 35%;">
                                <span id="total" runat="server"></span>&nbsp;<span id="unitx" runat="server"></span>
                            </td>
                            <td style="width: 15%;">
                                <span class="btn btn-info dictionaryX">分库数量：</span>
                            </td>
                            <td style="width: 35%;">
