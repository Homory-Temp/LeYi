<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InEdit.aspx.cs" Inherits="DepotAction_InEdit" %>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-left">
                            <telerik:RadNumericTextBox ID="amount" runat="server" NumberFormat-DecimalDigits="2" MinValue="0" DataType="System.Decimal" AllowOutOfRangeAutoCorrect="true" Width="400" ClientEvents-OnValueChanged="calc"></telerik:RadNumericTextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 text-right">入库单价：</div>
                        <div class="col-md-8 text-left">
                            <telerik:RadNumericTextBox ID="perPrce" runat="server" NumberFormat-DecimalDigits="2" MinValue="0" DataType="System.Decimal" AllowOutOfRangeAutoCorrect="true" Width="400" ClientEvents-OnValueChanged="calc"></telerik:RadNumericTextBox>
                        </div>
                    </div>
                    <div class="row">
