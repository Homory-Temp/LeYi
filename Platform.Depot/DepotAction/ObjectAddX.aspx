        ...
        <telerik:RadCodeBlock ID="cb" runat="server">
            <script>
                function sh(sender, args) {
                    ...
                    if ($find("<%= t1.ClientID %>"))
                        $find("<%= t1.ClientID %>").set_checked(v == "Consumable");
                    if ($find("<%= t2.ClientID %>"))
                        $find("<%= t2.ClientID %>").set_checked(v == "Use");
                    if ($find("<%= t3.ClientID %>"))
                            ...
                            <div>
                                <table>
                                    <tr id="r1" runat="server">
                                        <td>
                                            <telerik:RadButton ID="t1" runat="server" GroupName="c" Text="易耗品（领用）" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="CheckBox" Value="Consumable" OnClientClicked="sh"></telerik:RadButton>
                                        </td>
                                    </tr>
                                    <tr id="r2" runat="server">
                                        <td>
                                            <telerik:RadButton ID="t2" runat="server" GroupName="c" Text="低值非易耗（领用借用）" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="CheckBox" Value="Use" OnClientClicked="sh"></telerik:RadButton>
                                        </td>
                                    </tr>
