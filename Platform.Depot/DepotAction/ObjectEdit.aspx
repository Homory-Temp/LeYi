<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObjectEdit.aspx.cs" Inherits="DepotAction_ObjectEdit" %>
...
<body>
    <form id="form" runat="server">
        <homory:SideBarSingle runat="server" ID="SideBarSingle" Crumb="物资管理 - 编辑物资" />
