...
<body>
    <form id="form" runat="server">
        <homory:SideBarSingle runat="server" ID="SideBarSingle" Crumb="物资管理 - 盘库导入" />
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <telerik:RadButton ID="im_do" runat="server" Text="预览要导入的盘库数据" OnClick="im_do_Click"></telerik:RadButton>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div>
                        ...
                        <telerik:RadButton ID="im_ok" runat="server" Text="开始导入离线盘库数据" OnClick="im_ok_Click"></telerik:RadButton>
                    </div>
                </div>
            </div>
        </telerik:RadAjaxPanel>
