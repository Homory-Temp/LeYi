...
public partial class Depot_DepotHome : DepotPageSingle
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            C.InnerText = q.Sum(o => o.Amount).ToAmount(Depot.Featured(Models.DepotType.小数数量库));
            M.InnerText = DataContext.DepotOrder.Where(o => o.DepotId == Depot.Id && o.State < Models.State.停用).Sum(o => o.Paid).ToString().ToMoney();
        }
    }
}
