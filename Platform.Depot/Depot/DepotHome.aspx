                ...
                <div class="col-md-6">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <a class="btn btn-info dictionaryX" href='<%= "../DepotAction/Import?DepotId={0}".Formatted(Depot.Id) %>' style='<%= (Depot.Featured(Models.DepotType.固定资产库) && Depot.Featured(Models.DepotType.幼儿园) ? "display: ;": "display: none;") %>'>资产导入</a>
                            <a class="btn btn-info dictionaryX" href='<%= "../DepotAction/ImportX?DepotId={0}".Formatted(Depot.Id) %>' style='<%= (Depot.Featured(Models.DepotType.固定资产库) && !Depot.Featured(Models.DepotType.幼儿园) ? "display: ;": "display: none;") %>'>资产导入</a>
                ...
                <div class="col-md-6">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <a class="btn btn-info dictionaryX" href='<%= "../DepotScan/CheckList?DepotId={0}".Formatted(Depot.Id) %>'>盘库查询</a>
