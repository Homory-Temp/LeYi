<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TargetEdit.aspx.cs" Inherits="StoreAction_TargetEdit" %>
...
<body>
    <form id="form" runat="server">
        <homory:SideBarSingle runat="server" ID="SideBarSingle" Crumb="物资管理 - 购置编辑" />
        ...
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="container-fluid" LoadingPanelID="loading">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-4 text-right">采购来源：</div>
                        <div class="col-md-8 text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-left">
                            <telerik:RadComboBox ID="keep" runat="server" LocalizationPath="~/Language" DataTextField="RealName" DataValueField="Id" Filter="Contains" MarkFirstMatch="true" AppendDataBoundItems="true" ShowToggleImage="false" Width="400" AllowCustomText="true">
                                <Items>
                                    <telerik:RadComboBoxItem Text="" Value="" Selected="true" />
                                </Items>
                                <ItemTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-left">
                            <telerik:RadComboBox ID="brokerage" runat="server" LocalizationPath="~/Language" DataTextField="RealName" DataValueField="Id" Filter="Contains" MarkFirstMatch="true" AppendDataBoundItems="true" ShowToggleImage="false" Width="400" AllowCustomText="true">
                                <Items>
                                    <telerik:RadComboBoxItem Text="" Value="" Selected="true" />
                                </Items>
                                <ItemTemplate>
