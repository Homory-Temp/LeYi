                ...
                <ul class="nav navbar-nav" style="float: right; margin-right: 80px;">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href='<%= "../DepotAction/Import?DepotId={0}".Formatted(Depot.Id) %>' style='<%= (Depot.Featured(Models.DepotType.固定资产库) && Depot.Featured(Models.DepotType.幼儿园) ? "display: ;": "display: none;") %>'>资产导入</a></li>
                            <li><a href='<%= "../DepotAction/ImportX?DepotId={0}".Formatted(Depot.Id) %>' style='<%= (Depot.Featured(Models.DepotType.固定资产库) && !Depot.Featured(Models.DepotType.幼儿园) ? "display: ;": "display: none;") %>'>资产导入</a></li>
