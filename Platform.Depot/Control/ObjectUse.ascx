...
<tr>
    ...
    <td>
        <telerik:RadNumericTextBox ID="amount" runat="server" Width="120" NumberFormat-DecimalDigits="2" DataType="System.Decimal" AllowOutOfRangeAutoCorrect="false"></telerik:RadNumericTextBox>
