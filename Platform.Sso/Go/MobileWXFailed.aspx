    ...
    <div class="login-form" style="margin: 30px auto 0 auto; width: 86%;">
        ...
        <form runat="server">
            ...
            <telerik:RadAjaxPanel ID="areaAction" runat="server">
                <input id="code_btn" name="textx" type="text" readonly="readonly" value="提交失败，请联系管理员" style="cursor: pointer; border: 1px solid dimgray; width: 50%; text-align: center; height: auto;" onclick="send_code();" /><br /><br />
