<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobileWXFailed.aspx.cs" Inherits="Go.GoMobileWXFailed" %>
...
<body style="min-height: 600px;">
    ...
    <div class="login-form" style="margin: 30px auto 0 auto; width: 86%;">
        ...
        <form runat="server">
            ...
            <telerik:RadAjaxPanel ID="areaAction" runat="server">
                <input id="code_btn" name="textx" type="text" readonly="readonly" value="提交失败，请联系管理员" style="cursor: pointer; border: 1px solid dimgray; width: 50%; text-align: center; height: auto;" /><br /><br />
    ...
    <div class="bottom2016">
        Copyright &copy;2016 梁溪区教育局<br />技术支持电话：82795099
    </div>
    <style>
