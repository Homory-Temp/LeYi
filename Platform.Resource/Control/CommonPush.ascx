<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommonPush.ascx.cs" Inherits="Control.ControlCommonPush" %>
    ...
    <div class="msgFeed user_feed mt15">
        ...
        <div class="frame-nav-inner" style="position: relative; top: -20px; border-bottom: 2px solid #CCC;">
            <ul class="fd-nav-list clearfix">
                <li class="fd-nav-item fd-nav-cur-item fd-nav-item-list"><a href="#" class="friends-original">名师工作室</a></li>
