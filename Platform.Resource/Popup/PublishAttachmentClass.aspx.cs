...
public partial class Popup_PublishAttachmentClass : System.Web.UI.Page
{
    ...
    protected User CurrentUser
    {
        get
        {
            ...
            var id = Guid.Parse(Request.QueryString["UserId"].ToString());
    ...
    protected Resource CurrentResource
    {
        get
        {
            return CurrentUser.Resource.First(o => o.State == State.审核 && o.Type == ResourceType && o.AssistantType == 1);
        }
    }
    ...
    protected void publish_attachment_upload_FileUploaded(object sender, FileUploadedEventArgs e)
    {
