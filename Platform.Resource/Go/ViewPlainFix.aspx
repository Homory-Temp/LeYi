<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPlainFix.aspx.cs" Inherits="Go.GoViewPlainFix" %>
...
<head runat="server">
    ...
    <script src="../Content/Homory/js/pdfobject.js"></script>
    <base target="_top" />
    <script>
        ...
        if (isIE())
            fixedIE('./ViewPlain?Id=' + GetUrlParmsEx('Id'));
    </script>
</head>
<body>
                        ...
                        <div class="srx-left" style="background-color: #FFF">
                            <telerik:RadCodeBlock runat="server">
                                ...
                                <div id="vp1" runat="server" class="j-content clearfix">
                                    ...
                                    <div id="pdfZone" style="margin-top: 10px;"></div>
