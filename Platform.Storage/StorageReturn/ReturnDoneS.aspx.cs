...
public partial class ReturnDoneS : SingleStoragePage
{
    ...
    protected string ReturnList(StorageReturn r)
    {
        var x = r.StorageReturnSingle.Select(o => o.Ordinal).ToList().Select(o => o.ToString());
