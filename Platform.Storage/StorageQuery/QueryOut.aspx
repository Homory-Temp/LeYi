<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryOut.aspx.cs" Inherits="QueryOut" %>
    ...
    <form id="form" runat="server">
        ...
        <telerik:RadAjaxPanel ID="storage_panel" runat="server" CssClass="grid-container" EnableAJAX="true" ClientEvents-OnRequestStart="ajax_onRequestStart">
               <div class="grid-100 mobile-grid-100 grid-parent left">
                <h4 style="margin-left:20px;">报废查询</h4>
            </div>
            <hr>
                ...
                <div class="grid-85 grid-parent">
                    ...
                    <div class="grid-100 mobile-grid-100"  style="margin-top: 10px; ">
                        <telerik:RadGrid ID="view" runat="server" OnNeedDataSource="view_NeedDataSource" AutoGenerateColumns="false">
                            <MasterTableView DataKeyNames="报废标识"  CommandItemDisplay="TopAndBottom">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="日期" HeaderText="报废日期"></telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="报废类型" HeaderText="报废类型"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="报废原因" HeaderText="报废原因"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="报废人" HeaderText="报废人"></telerik:GridBoundColumn>
