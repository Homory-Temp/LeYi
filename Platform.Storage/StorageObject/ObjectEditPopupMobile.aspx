<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ObjectEditPopupMobile.aspx.cs" Inherits="ObjectEditPopupMobile" %>
    ...
    <form id="form" runat="server">
        ...
        <div class="am-cf am-padding" style="border-bottom: 1px solid #E1E1E1;">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg">编辑物品</strong>
            </div>
        </div>
            ...
            <telerik:RadAjaxPanel ID="ap" runat="server">
                <div class="grid-100 mobile-grid-100 grid-parent">
                    ...
                    <div style="height: 20px;">
                        ...
                        <asp:ImageButton ID="cancel" runat="server" AlternateText="取消" OnClick="cancel_Click" class="btn btn-xm btn-default" style="display: none;"></asp:ImageButton>
                    </div>
                </div>
