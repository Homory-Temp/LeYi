<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LendDoneS.aspx.cs" Inherits="LendDoneS" %>
    ...
    <form id="form" runat="server">
        ...
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="grid-container">
            ...
            <div class="grid-100 mobile-grid-100 grid-parent">
                <table class="table table-bordered" style="margin-top: 10px;" align="center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td align="left"><telerik:RadListView ID="view" runat="server" OnNeedDataSource="view_NeedDataSource">
                                <ItemTemplate>
                                    <%# Container.DataItem %>
                                </ItemTemplate>
                            </telerik:RadListView>
                ...
                <div class="grid-100 mobile-grid-100 grid-parent">
                    <asp:ImageButton AlternateText="借用同类物品" ID="in_obj" runat="server" OnClick="in_obj_Click" class="btn btn-xm btn-default"/>
                    <asp:ImageButton AlternateText="借用他类物品" ID="in_other" runat="server" OnClick="in_other_Click" class="btn btn-xm btn-default" />
                    <asp:ImageButton AlternateText="返回首页" ID="in_back" runat="server" OnClick="in_back_Click"  class="btn btn-xm btn-default"/>
                </div>
