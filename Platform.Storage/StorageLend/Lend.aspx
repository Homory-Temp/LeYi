<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lend.aspx.cs" Inherits="Lend" %>
...
<body>
    <form id="form" runat="server">
        ...
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="grid-container">
            ...
            <div class="grid-100 mobile-grid-100 grid-parent">
                <asp:ImageButton AlternateText="借用" ID="in" runat="server" Visible="false" OnClick="in_Click" />
            </div>
