...
public partial class ScanQuery : StoragePage
{
            ...
            case "W":
                {
                    ...
                    piles.AddRange(source.Select(o => new Expo { 库存 = 0, 单位 = obj.Unit, 标识 = o.Id, 时间 = o.Time, 日期 = o.TimeNode.TimeNode(), 类型 = "入库", 数量 = o.Amount, 人员 = db.Value.UserName(o.OperationUserId) }));
            ...
            case "D":
                {
                    ...
                    piles.Add(new Expo { 库存 = 0, 标识 = obj.StorageIn.Id, 单位 = unit, 时间 = obj.StorageIn.Time, 日期 = obj.StorageIn.TimeNode.TimeNode(), 类型 = "入库", 数量 = 1, 人员 = db.Value.UserName(obj.StorageIn.OperationUserId) });
