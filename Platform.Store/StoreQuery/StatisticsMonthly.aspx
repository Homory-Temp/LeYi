<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatisticsMonthly.aspx.cs" Inherits="StoreQuery_StatisticsMonthly" %>
...
<body>
    <form id="form" runat="server">
        <homory:SideBarSingle runat="server" ID="SideBarSingle" Crumb="日常查询 - 月库存报表" />
        <telerik:RadAjaxPanel ID="ap" runat="server" CssClass="container-fluid" LoadingPanelID="loading">
            <div class="row">
                ...
                <div class="col-md-10" style="text-align: left;">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="btn btn-info">期间：</span>
                            <telerik:RadMonthYearPicker ID="px" runat="server" LocalizationPath="~/Language" ShowPopupOnFocus="true" Width="100" AutoPostBack="false">
