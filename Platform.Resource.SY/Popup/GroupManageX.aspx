<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupManageX.aspx.cs" Inherits="Popup_GroupManageX" %>
				...
				<table style="vertical-align: top; margin-left: 10px; line-height: 30px;">
					...
					<tr>
						<td colspan="2" style="text-align: center;">
							<a id="btnCreate" runat="server" class="button24 srx-ciptbox-submit" target="_self" onserverclick="btnCreate_ServerClick" style="width: 60px;"><em>保存</em></a>
						</td>
					</tr>
				</table>
