...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		以下是播放器自带的二个插件
		*/
        control_rel: 'related.swf,XsfxPlayer/related.xml,0',
        /*
		视频结束显示精彩视频的插件
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
		myweb: escape('97a604bba8de70e829e1f9671ab27400,锡师附小,http://www.xsfx.com/,互动资源平台播放系统 v1.0'),
        /*
		------------------------------------------------------------------------------------------------------------------
		...
		*/
        cpt_share: 'XsfxPlayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
...
(function() {
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
            ...
            t = '<a href="' + r + '">请点击此处下载安装最新的flash插件</a>',
            error = {
