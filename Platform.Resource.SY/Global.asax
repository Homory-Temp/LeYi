...
<script RunAt="server">
    ...
    void Application_Start(object sender, EventArgs e)
    {
        ...
        Application["Sso"] = HomoryContext.Value.Application.First(o => o.Id == id).Home.Replace("Go/SignOn", "");
        var cid = Guid.Parse("3047e587-8cc1-4645-8536-08d1af49409f");
        Application["Core"] = HomoryContext.Value.Application.First(o => o.Id == cid).Home.Replace("Go/Home", "");
        var rid = Guid.Parse("ce43e587-8cc0-4a1c-bf9e-08d1af495d0c");
        Application["Resource"] = HomoryContext.Value.Application.First(o => o.Id == rid).Home.Replace("Go/Home", "");
    }
